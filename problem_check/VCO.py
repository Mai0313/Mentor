...
if (average_period - 1e-5 > average_period2 and average_period - 1e-5 > average_period3) or (
    average_period + 1e-5 < average_period2 and average_period + 1e-5 < average_period3
):
