...
do
  ...
  tmux send-keys -t run_sessions:window_$window_index "conda activate analog && export PATH="/home/mtk34272/.conda/envs/analog/bin:$PATH" && python gpt_run.py --num_per_task=5 --num_of_retry=5 --model=aide-gpt-4o --task_id=$task_id" C-m
