...
circuit.MOSFET(
    "5", "Source1", "Vbias1", circuit.gnd, circuit.gnd, model="nmos_model", w=50e-6, l=1e-6
)
...
circuit.MOSFET(
    "3", "Voutp", "Drain1", circuit.gnd, circuit.gnd, model="nmos_model", w=50e-6, l=1e-6
)
circuit.MOSFET("8", "Voutp", "Vbias2", "Vdd", "Vdd", model="pmos_model", w=50e-6, l=1e-6)
circuit.MOSFET(
    "4", "Vout", "Drain2", circuit.gnd, circuit.gnd, model="nmos_model", w=50e-6, l=1e-6
)
