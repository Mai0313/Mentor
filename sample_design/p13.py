...
circuit.MOSFET(
    "1", "Drain1", "Vinp", "SourceCommon", "SourceCommon", model="nmos_model", w=50e-6, l=1e-6
)
circuit.MOSFET(
    "2", "Drain2", "Vinn", "SourceCommon", "SourceCommon", model="nmos_model", w=50e-6, l=1e-6
)
# Tail Current Source: M3
circuit.MOSFET(
    "3", "SourceCommon", "Vbias", circuit.gnd, circuit.gnd, model="nmos_model", w=100e-6, l=1e-6
)
# Load Resistors
